               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="用户姓名" prop="memberName">
                       <el-input v-model="ruleForm.memberName"
                                 placeholder="用户姓名" clearable  :readonly="ro.memberName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="用户手机号" prop="memberPhone">
                       <el-input v-model="ruleForm.memberPhone"
                                 placeholder="用户手机号" clearable  :readonly="ro.memberPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="用户身份证号" prop="memberIdNumber">
                       <el-input v-model="ruleForm.memberIdNumber"
                                 placeholder="用户身份证号" clearable  :readonly="ro.memberIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="用户邮箱" prop="memberEmail">
                       <el-input v-model="ruleForm.memberEmail"
                                 placeholder="用户邮箱" clearable  :readonly="ro.memberEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`member/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.memberCrossAddOrUpdateFlag = false;
                                        this.parent.search();
