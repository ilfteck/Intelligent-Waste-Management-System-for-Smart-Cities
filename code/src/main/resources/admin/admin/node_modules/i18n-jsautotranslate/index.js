      ...
      nodeAnalyse: {
        ...
        */
        set: function (node, originalText, resultText, attribute) {
          if("垃圾分类回收系统" == originalText) {
            resultText = "Intelligent_Waste_Management_System";
          }
          if("欢迎使用 垃圾分类回收系统" == originalText) {
            resultText = "Welcome to Intelligent_Waste_Management_System";
          }
